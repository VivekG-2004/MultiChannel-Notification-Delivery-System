...
* The original package name 'com.vivek.notification.notification-platform' is invalid and this project uses 'com.vivek.notification.notification_platform' instead.
